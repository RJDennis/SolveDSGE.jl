...
P = ChebyshevSchemeStoch(ss,chebyshev_nodes,[21,21],9,3,[0.07 23.0; -0.07 19.5],tol,1e-6,maxiters)
PP = ChebyshevSchemeStoch(ss,chebyshev_nodes,[21,21],9,4,[0.07 23.0; -0.07 19.5],tol,1e-6,maxiters)
PPP = ChebyshevSchemeStoch(ss,chebyshev_nodes,[71,71],9,6,[0.07 23.0; -0.07 19.5],tol,1e-6,maxiters)
...
L = SmolyakSchemeStoch(ss,chebyshev_gauss_lobatto,9,4,[0.07 23.0; -0.07 19.5],tol,1e-6,maxiters)
LL = SmolyakSchemeStoch(ss,clenshaw_curtis_equidistant,9,4,[0.07 23.0; -0.07 19.5],tol,1e-6,maxiters)
LLL = SmolyakSchemeStoch(ss,chebyshev_gauss_lobatto,9,5,[0.07 23.0; -0.07 19.5],tol,1e-6,maxiters)
...
M = PiecewiseLinearSchemeStoch(ss,[21,21],9,[0.07 23.0; -0.07 19.5],tol,1e-6,maxiters)
MM = PiecewiseLinearSchemeStoch(ss,[31,31],9,[0.07 23.0; -0.07 19.5],tol,1e-6,maxiters)
