...
P = ChebyshevSchemeDet(ss,chebyshev_nodes,[21,21],3,[0.07 23.0; -0.07 19.5],tol,1e-6,maxiters)
PP = ChebyshevSchemeDet(ss,chebyshev_nodes,[21,21],4,[0.07 23.0; -0.07 19.5],tol,1e-6,maxiters)
PPP = ChebyshevSchemeDet(ss,chebyshev_nodes,[71,71],6,[0.07 23.0; -0.07 19.5],tol,1e-6,maxiters)
...
L = SmolyakSchemeDet(ss,chebyshev_gauss_lobatto,4,[0.07 23.0; -0.07 19.5],tol,1e-6,maxiters)
LL = SmolyakSchemeDet(ss,clenshaw_curtis_equidistant,4,[0.07 23.0; -0.07 19.5],tol,1e-6,maxiters)
LLL = SmolyakSchemeDet(ss,chebyshev_gauss_lobatto,5,[0.07 23.0; -0.07 19.5],tol,1e-6,maxiters)
...
M = PiecewiseLinearSchemeDet(ss,[21,21],[0.07 23.0; -0.07 19.5],tol,1e-6,maxiters)
MM = PiecewiseLinearSchemeDet(ss,[31,31],[0.07 23.0; -0.07 19.5],tol,1e-6,maxiters)
