...
%TCIDATA{LastRevised=Monday, May 10, 2021 00:46:53}
...
\title{SolveDSGE v0.4.4 --- A User Guide}
\date{April 2021}
\maketitle
...
\item hssx --- The skewness adjustment to the state-transition equation
...
\item gssx --- The skewness adjustment to the jump's equation
